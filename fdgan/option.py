...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--netE-pretrain', type=str, default='/home/dingyuhang/FD-GAN-master/model1/stage2/100_net_E.pth')
        self.parser.add_argument('--netG-pretrain', type=str, default='/home/dingyuhang/FD-GAN-master/model1/stage2/100_net_G.pth')
        self.parser.add_argument('--netDp-pretrain', type=str, default='/home/dingyuhang/FD-GAN-master/model1/stage2/100_net_Dp.pth')
        self.parser.add_argument('--netDi-pretrain', type=str, default='/home/dingyuhang/FD-GAN-master/model1/stage2/100_net_Di.pth')
        # model structures
        ...
        self.parser.add_argument('--display-port', type=int, default=8000, help='visdom port of the web display')
